...
# This script is in lambda/cluster-scraper, so go up 2 levels to root
...
def deploy_container():
    ...
    subprocess.run([
        "docker", "buildx", "build", "--platform", "linux/amd64", "--provenance=false", "--output", "type=docker", "-t", "cluster-scraper", "."
